...
*/
//#if 1
#ifndef _TINY_GPS2_H_
#define _TINY_GPS2_H_
/*
...
#include <Arduino.h>
  ...
  enum {
    GPS_INVALID_AGE = 0xFFFFFFF,      GPS_INVALID_ANGLE = 99999999,
    GPS_INVALID_ALTITUDE = 99999999,  GPS_INVALID_DATE = 0,
    GPS_INVALID_TIME = 0xFFFFFFF,		 GPS_INVALID_SPEED = 99999999,
    GPS_INVALID_FIX_TIME = 0xFFFFFFF, GPS_INVALID_SATELLITES = 0xFF,
    GPS_INVALID_HDOP = 0xFFFFFFF
  };
