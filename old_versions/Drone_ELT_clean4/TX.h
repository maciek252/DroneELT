...
//      giveTinyGPS()->hdop();    
  ...
  Serial.print(flon);
    ...
    Serial.print(giveTinyGPS()->satellites() == TinyGPS::GPS_INVALID_SATELLITES ? 0 : giveTinyGPS()->satellites());
    Serial.print(" PREC=");
    Serial.print(giveTinyGPS()->hdop() == TinyGPS::GPS_INVALID_HDOP ? 0 : giveTinyGPS()->hdop());
